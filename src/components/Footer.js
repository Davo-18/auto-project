...
const Footer = () => {
    ...
    return(
        <div className="App__footer" >
            ...
            <a href="tel: +79015817625" style={{color: 'white', fontSize: 30, textAlign: 'left', position: 'relative', left: -555, top: 150}}>+79015817625</a>
            ...
            <h4 style={{color: '#21a038', fontSize: 30, position: 'relative', left: -570, top: 150}}>АВТОВЫКУП</h4>
            </div>
