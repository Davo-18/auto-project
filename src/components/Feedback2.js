...
const Feedback2 = () => {
    ...
    return(
        <div className="App_feedback2" style={{position: 'relative', top: -200}}>
            <h1 className="h1__first" style={{marginLeft: 900, position: 'relative', left: 400, textAlign: 'left', fontSize: 40}}>Узнайте стоимость вашего автомобиля
...
<button className='first_btn' type="submit" style={{fontSize: 12, position: 'relative', left: 20}}><a href="whatsapp://send?phone=+79015817625" style={{textDecoration: 'none', color: 'white'}}>Стоимость в WhatsApp</a></button>
